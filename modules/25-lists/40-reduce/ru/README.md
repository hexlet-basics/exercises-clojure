...
В большинстве случаев используют левую свёртку (`reduce`) потому, что она более интуитивна — двигается от первого элемента к последнему — и работает _эффективнее_. Однако иногда полезна именно правая, но в стандартной библиотеке она отсутствует.
